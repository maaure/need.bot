...
createCommand({
    name: "time",
    description: "Gerencie times: crie, adicione, remova jogadores e defina capitão.",
    type: ApplicationCommandType.ChatInput,
    options: [
        {
            name: "novo",
            description: "Cadastre um novo time, criando cargo e canal de voz privado para ele.",
            ...
            options: [
                ...
                {
                    name: "capitao",
                    description: "Mencione o capitão do time. Se não, você será o capitão.",
        ...
        {
            name: "sair",
            description: "Saia do time. Se for capitão, transfere cargo; se último, exclui o time.",
            type: ApplicationCommandOptionType.Subcommand,
            options: [
                {
                    name: "time",
